...
def allocate_text_by_lang(texts):
    ...
    return {'en': texts_en, 'ms': texts_ms, 'id': texts_id, 'zh': texts_zh, 'ta': texts_ta}


@plac.opt('root_dir', "Input File", type=Path)
def main(root_dir='/home/xuanlong/dataclean/data'):
